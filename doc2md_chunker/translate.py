...
LLM_MODEL_DEFAULT_BASE_URL = os.getenv(
    "LLM_MODEL_DEFAULT_BASE_URL", "http://ollama:11434"
).rstrip("/")
LLM_MODEL_TRANSLATE_BASE_URL = os.getenv(
    "LLM_MODEL_TRANSLATE_BASE_URL", LLM_MODEL_DEFAULT_BASE_URL
).rstrip("/")

TRANSLATE_MODEL = os.getenv("TRANSLATE_MODEL", os.getenv("LLM_MODEL", "gemma3:4b"))
OLLAMA_LLM_CONTEXT_LENGTH = int(os.getenv("OLLAMA_LLM_CONTEXT_LENGTH", 4096))
OLLAMA_LLM_NUM_PREDICT = int(os.getenv("OLLAMA_LLM_NUM_PREDICT", 2048))
OLLAMA_LLM_SAFETY_MARGIN_TOKENS = int(os.getenv("OLLAMA_LLM_SAFETY_MARGIN_TOKENS", 512))
OLLAMA_LLM_MAX_RETRIES = int(os.getenv("OLLAMA_LLM_MAX_RETRIES", 2))
OLLAMA_LLM_RETRY_BACKOFF_SECONDS = float(os.getenv("OLLAMA_LLM_RETRY_BACKOFF_SECONDS", 1.5))
